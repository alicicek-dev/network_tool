...
// Ping / Trace Icon (Activity Line Graph / Pulse)
export function PingIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
...
// Web Terminal Icon (Command Prompt Console)
...
// Discovery Icon (Search / Magnifying Glass)
...
// Utilities Icon (Settings Wrench & Gear)
...
// Speed Test Icon (Speedometer Gauge)
export function SpeedTestIcon(props: SVGProps<SVGSVGElement>) {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
      <path d="M2 12c0-5.5 4.5-10 10-10s10 4.5 10 10" />
      <path d="M19 19c-1-1.5-2.5-2.5-4.5-2.5S11 17.5 10 19" />
      <path d="m12 14 3-3" />
...
// Refresh Icon (Rotate Circular Arrow)
...
// Copy Icon (Clipboard/Files overlapping)
...
// Server Icon (Quick Servers Stacked Chassis)
