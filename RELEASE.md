...
Bu sürüm; uygulamanın modülerliğini artırmak, performans optimizasyonları sağlamak ve çoklu oturum desteği sunmak amacıyla gerçekleştirilen büyük bir refaktör çalışmasını içerir.
...
- 🖥️ **Çoklu Sekmeli Terminal**: Aynı anda birden fazla SSH, Telnet ve Serial console bağlantısı açın ve yönetin.
